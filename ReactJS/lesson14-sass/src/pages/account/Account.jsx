    ...
    <div className="d-flex align-items-center justify-content-center flex-column">
        ...
        <div className="col-6">
            ...
            <div className="d-flex flex-column justfiy-content-center align-items-center">
                ...
                <button onClick={()=>{localStorage.removeItem('token');swal("Log out!", "After 2 seconds, the page will automatically redirect you.", "warning");
                setTimeout(() => {
                    window.location.assign('/')
                }, 2000)}} className='btn btn-outline-danger mt-4'>Log out </button>
            </div>
        </div>
