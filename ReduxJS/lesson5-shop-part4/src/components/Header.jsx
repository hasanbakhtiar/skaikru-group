            ...
            <div className="container">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav mx-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <NavLink className="nav-link" to="/outlet">{lang ==="az"?"Outlet":"Outlet"}</NavLink>
                        </li>
                        <li className="nav-item">
                    ...
                    {localStorage.getItem('token')?<span className='text-light ms-3'>Hello,<Link to="/account" className='text-light'>{localStorage.getItem('superuser')?superuser.name:auth[0].name} </Link></span>:<Link to="/login" className='btn btn-secondary ms-3'>Login</Link>}
                    {localStorage.getItem('superuser')?<Link className='btn btn-danger ms-3' to="/dashboard">Dashboard</Link>:""}
                </div>
            </div>
        </nav>
